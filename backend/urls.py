...
from backend.views import word2vec_summary
from backend.views import word2vec
...
urlpatterns = [
    ...
    path('word2vec_summary', word2vec_summary, name='word2vec_summary'),
    path('word2vec', word2vec, name='word2vec'),
